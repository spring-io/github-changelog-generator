...
java -jar release-git-repo/target/github-changelog-generator.jar --changelog.repository=spring-io/github-changelog-generator $releaseVersion built-artifact/changelog.md
